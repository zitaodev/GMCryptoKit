...
- (void)testSm2CryptorVerifyTextSignature {
    ...
    BOOL verified = [GMSm2Cryptor gm_sm2VerifySignature:base64Signature forMessage:message withBase64PublicKey:publicKeyBase64];
...
- (void)testSm2CryptorVerifyHexSignature {
    ...
    BOOL verified = [GMSm2Cryptor gm_sm2VerifyHexSignature:hexSignature forHexMessage:hexMessage withHexPublicKey:publicKeyHex];
    XCTAssertTrue(verified);
}
...
- (void)testSm2CryptorDecryptText {
    ...
    NSString *decryptedtext = [GMSm2Cryptor gm_sm2DecryptText:ciphertextBase64Encoded withBase64PrivateKey:privateKeyBase64Encoded];
...
- (void)testSm2CryptorDecryptHexText {
    ...
    NSString *decryptedHextext = [GMSm2Cryptor gm_sm2DecryptHexText:ciphertextHextext withHexPrivateKey:privateKeyHex];
...
- (void)testSm2CryptorEncryptText {
    ...
    NSString *base64Ciphertext = [GMSm2Cryptor gm_sm2EncryptText:self.plaintext withBase64PublicKey:publicKeyBase64];
...
- (void)testSm2CryptorCreateBase64KeyPair {
    NSDictionary<NSString *, NSString *> *keyPair = [GMSm2Cryptor gm_createSm2Base64KeyPair];
...
- (void)testSm2CryptorCreateHexKeyPair {
    NSDictionary<NSString *, NSString *> *keyPair = [GMSm2Cryptor gm_createSm2HexKeyPair];
    NSString *publicKey = keyPair[@"publicKey"];
    NSString *privateKey = keyPair[@"privateKey"];
    XCTAssertNotNil(publicKey, @"生成公钥不能为空");
    XCTAssertNotNil(privateKey, @"生成私钥不能为空");
...
- (void)testSm2CryptorThrows {
    ...
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2VerifySignature:nil forMessage:@"" withBase64PublicKey:@""]);
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2VerifySignature:@"" forMessage:nil withBase64PublicKey:@""]);
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2VerifySignature:@"" forMessage:@"" withBase64PublicKey:nil]);
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2VerifyHexSignature:nil forHexMessage:@"" withHexPublicKey:@""]);
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2VerifyHexSignature:@"" forHexMessage:nil withHexPublicKey:@""]);
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2VerifyHexSignature:@"" forHexMessage:@"" withHexPublicKey:nil]);
    ...
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2SignText:nil withBase64PrivateKey:@""]);
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2SignText:@"" withBase64PrivateKey:nil]);
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2SignHexText:nil withHexPrivateKey:@""]);
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2SignHexText:@"" withHexPrivateKey:nil]);
    ...
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2DecryptText:nil withBase64PrivateKey:@""]);
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2DecryptText:@"" withBase64PrivateKey:nil]);
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2DecryptHexText:nil withHexPrivateKey:@""]);
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2DecryptHexText:@"" withHexPrivateKey:nil]);
    ...
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2EncryptText:nil withBase64PublicKey:@""]);
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2EncryptText:@"" withBase64PublicKey:nil]);
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2EncryptHexText:nil withHexPublicKey:@""]);
    XCTAssertThrows((void) [GMSm2Cryptor gm_sm2EncryptHexText:@"" withHexPublicKey:nil]);
...
- (void)testPerformanceSm2VerifyText {
    NSString *base64Signature = [GMSm2Cryptor gm_sm2SignText:self.plaintext withBase64PrivateKey:self.privateKeyBase64];
    [self measureBlock:^{
        BOOL isSignatureValid = [GMSm2Cryptor gm_sm2VerifySignature:base64Signature forMessage:self.plaintext withBase64PublicKey:self.publicKeyBase64];
...
- (void)testPerformanceSm2VerifyHex {
    ...
    NSString *hexSignature = [GMSm2Cryptor gm_sm2SignHexText:hexMessage withHexPrivateKey:self.privateKeyHex];
    [self measureBlock:^{
        BOOL isSignatureValid = [GMSm2Cryptor gm_sm2VerifyHexSignature:hexSignature forHexMessage:hexMessage withHexPublicKey:self.publicKeyHex];
        XCTAssertTrue(isSignatureValid, @"签名验签需成功");
    }];
}
...
- (void)testPerformanceSm2Sign {
    ...
    [self measureBlock:^{
        NSData *signatureData = [GMSm2Cryptor gm_sm2SignData:messageData withPrivateKey:self.privateKeyData];
        XCTAssertNotNil(signatureData, @"数字签名不能为空");
    }];
}

- (void)testPerformanceSm2DecryptText {
    NSString *base64Ciphertext = [GMSm2Cryptor gm_sm2EncryptText:self.plaintext withBase64PublicKey:self.publicKeyBase64];
    [self measureBlock:^{
        NSString *decryptedtext = [GMSm2Cryptor gm_sm2DecryptText:base64Ciphertext withBase64PrivateKey:self.privateKeyBase64];
        XCTAssertNotNil(decryptedtext, @"解密结果不能为空");
    }];
}
...
- (void)testPerformanceSm2DecryptHexText {
    ...
    NSString *hexCiphertext = [GMSm2Cryptor gm_sm2EncryptHexText:plaintextHex withHexPublicKey:self.publicKeyHex];
    [self measureBlock:^{
        NSString *decryptedHextext = [GMSm2Cryptor gm_sm2DecryptHexText:hexCiphertext withHexPrivateKey:self.privateKeyHex];
        XCTAssertNotNil(decryptedHextext, @"解密结果不能为空");
    }];
}
...
- (void)testPerformanceSm2EncryptText {
    [self measureBlock:^{
        NSString *ciphertextBase64 = [GMSm2Cryptor gm_sm2EncryptText:self.plaintext withBase64PublicKey:self.publicKeyBase64];
...
- (void)testPerformanceSm2EncryptHexText {
    NSString *plaintextHex = [GMUtilities stringToHexString:self.plaintext];
    [self measureBlock:^{
        NSString *ciphertextHex = [GMSm2Cryptor gm_sm2EncryptHexText:plaintextHex
...
- (void)testPerformanceSm2Encrypt {
    NSData *plaintextData = [self.plaintext dataUsingEncoding:NSUTF8StringEncoding];
    [self measureBlock:^{
        NSData *ciphertextData = [GMSm2Cryptor gm_sm2EncryptData:plaintextData 

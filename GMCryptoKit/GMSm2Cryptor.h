...
/**
 ...
 @param signatureBase64 消息签名，输入格式分别是：signatureBase64 Base64编码字符串、signatureHex Hex编码字符串、 signatureData UTF-8编码二进制数据
 @param message 原始消息，输入格式分别是：message UTF-8编码字符串、messageHex Hex编码字符串、 messageData UTF-8编码二进制数据
 @param publicKey 公钥,输入格式分别是Hex编码字符串或者UTF-8编码二进制数据
